            ...
            <div style="width:400px;margin:auto">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="registro_doenca.php"><button type="button" class="btn btn-danger">Cadastrar Doença</button></a><br/>
                        <a href=""><button type="button" class="btn btn-primary">Cadastra Caso de Doença</button></a><br/>
                        <a href=""><button type="button" class="btn btn-danger">Cadastrar Usuário Hospital</button></a><br/>
